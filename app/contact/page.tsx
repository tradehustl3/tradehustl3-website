...
export default function ContactPage() {
  return (
    <PolicyPage eyebrow="WE HAVE YOUR BACK" title="CONTACT SUPPORT" summary="One clear contact for Resume Builder, book delivery, payments, refunds, and privacy requests.">
      ...
      <PolicySection title="What we can help with"><ul><li>Missing magic-link or account access</li><li>Resume generation, correction, preview, PDF, or DOCX problems</li><li>Payment, duplicate charge, or refund questions</li><li>Missing free sample or purchased eBook delivery</li><li>Privacy, account access, correction, or deletion requests</li><li>General TRADE HUSTL3 questions</li></ul></PolicySection>
