...
const tradeChips = ['ATS-ready', 'Trade-specific language', 'PDF + DOCX', 'HVAC', 'Electrical', 'Plumbing', 'Welding', 'Maintenance'];
    ...
    <main className={styles.page}>
      ...
      <section className={styles.hero} id="top">
        <div className={styles.heroCopy}>
          ...
          <p className={styles.heroLead}>Turn real field experience into an ATS-ready resume with trade-specific language—built for HVAC, electrical, plumbing, welding, facilities, and maintenance professionals.</p>
      ...
      <section className={styles.doors} id="three-ways" aria-labelledby="doors-title">
        ...
        <div className={styles.doorGrid}>
          <AnalyticsLink href="/resume-builder" location="three_doors" event="select_content" item="resume_builder" className={`${styles.doorCard} ${styles.paidDoor}`}>
            ...
            <ul><li>ATS-ready</li><li>Trade-specific language</li><li>PDF + DOCX</li></ul><span className={styles.doorCta}>Build my resume <b aria-hidden="true">→</b></span>
          </AnalyticsLink>
