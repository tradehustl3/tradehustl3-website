...
export default function ResumeRefundPolicyPage() {
  return (
    <PolicyPage eyebrow="RESUME BUILDER" title="REFUND POLICY" summary="A straightforward policy for the $9.99 one-time TRADE HUSTL3 Resume Builder purchase.">
      <PolicySection title="What the purchase includes"><p>Your initial AI-assisted resume and protected watermarked preview are created before payment. Your $9.99 one-time purchase removes the watermark, provides one completed TRADE HUSTL3 resume as a clean PDF and editable DOCX, and unlocks up to three AI-assisted corrections during the seven days after payment. There is no subscription or recurring charge.</p></PolicySection>
