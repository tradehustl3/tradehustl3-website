...
export default function ResumeRefundPolicyPage() {
  return (
    <PolicyPage eyebrow="RESUME BUILDER" title="REFUND POLICY" summary="A straightforward policy for the $9.99 one-time TRADE HUSTL3 Resume Builder purchase.">
      ...
      <PolicySection title="Effect of refunds"><p>A partial refund does not revoke access unless the original $9.99 charge has been fully refunded. A full refund revokes the related entitlement, including remaining resume and cover-letter generation, correction, preview, and download access.</p></PolicySection>
