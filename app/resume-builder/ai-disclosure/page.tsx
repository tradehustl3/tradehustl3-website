...
export default function AiDisclosurePage() {
  return (
    <PolicyPage eyebrow="HUMAN FACTS. AI ASSISTED." title="AI DISCLOSURE" summary="How artificial intelligence assists the TRADE HUSTL3 Resume Builder and what every customer must review.">
      ...
      <PolicySection title="Information processing"><p>Your intake, text extracted from an uploaded resume, existing generated resume, target job posting, and correction request may be processed by Google Cloud or, during a controlled rollback, Anthropic to provide the service. The original uploaded PDF or DOCX is processed in your browser and is not stored by TRADE HUSTL3. Do not enter sensitive information that does not belong on a resume.</p></PolicySection>
