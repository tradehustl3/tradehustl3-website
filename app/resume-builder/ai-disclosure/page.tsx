...
export default function AiDisclosurePage() {
  return (
    <PolicyPage eyebrow="HUMAN FACTS. AI ASSISTED." title="AI DISCLOSURE" summary="How artificial intelligence assists the TRADE HUSTL3 Resume Builder and what every customer must review.">
      <PolicySection title="How AI is used"><p>The Resume Builder uses Anthropic&apos;s Claude model to organize and rewrite information supplied by the customer into an ATS-friendly resume. AI also assists with customer-requested corrections. It does not independently verify your employment, credentials, licenses, education, or identity.</p></PolicySection>
      ...
      <PolicySection title="Information processing"><p>Your intake, existing generated resume, target job posting, and correction request may be processed by Anthropic to provide the service. Do not enter sensitive information that does not belong on a resume.</p></PolicySection>
