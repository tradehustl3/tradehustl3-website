  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroCopy}>
          ...
          <p className={styles.lede}>
            You already signed up. No second form, no extra step. Read the cover, opening pages, table of contents, and the beginning of Chapter 1 below.
          </p>
      ...
      <section className={styles.finish}>
        ...
        <Link className={styles.primaryButton} href="/book" data-cta="the-book" data-cta-location="book-sample-finish">
