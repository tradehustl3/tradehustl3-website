...
export default function TermsPage() {
  return (
    <PolicyPage eyebrow="RULES OF THE PLATFORM" title="TERMS OF SERVICE" summary="The terms governing use of TRADE HUSTL3 LLC websites, digital products, and the Resume Builder.">
      ...
      <PolicySection title="3. Resume Builder purchase"><p>The $9.99 one-time Resume Builder purchase covers one completed resume: one initial AI-assisted build, a watermarked review copy, up to three AI-assisted corrections during the seven-day correction period, and clean PDF and editable DOCX files. It is not a subscription and does not renew automatically.</p></PolicySection>
